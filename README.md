...
Если уже работали с GitLab'ом, то нужно только переназначить ссылку на удаленный репозиторий командой ниже. 

Это нужно сделать для каждого локального репозитория.

``` bash
# вместо link подставить ссылку на ваш репозиторий
git remote set-url origin link
```

Если не работали, то просто клонируете репозиторий.
